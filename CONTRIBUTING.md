...
```toml
[app]
name         = "my-cool-app"        # app slug; staged under apps/<installation-id>/<repo-key>/<name>
display_name = "My Cool App"        # human-readable
platform     = "community"          # must match this platform repository
public       = true                 # visible to all runtime users
