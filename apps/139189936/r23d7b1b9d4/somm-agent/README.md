...
A thin Rust `cdylib` aomi app (`dyn_aomi_app!`, `aomi-sdk = "=3.0.1"`,
`platform = "somm.finance"`) that exposes the Agentic Somm yield agent's tools to
aomi's runtime. Each tool forwards to the **deployed Somm HTTP API** — it
